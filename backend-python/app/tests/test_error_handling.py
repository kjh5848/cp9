...
class TestErrorHandling:
    ...
    def test_coupang_extraction_error_handling(self, mock_service, client: TestClient):
        ...
        mock_service_instance.create_research_job_with_coupang_preview.side_effect = Exception("Coupang API error")
        ...
        response = client.post(
            "/api/v1/research/products?return_coupang_preview=true",
            json=request_data
        )
...
class TestErrorResponseStructure:
    ...
    def test_standard_error_structure(self):
        ...
        from app.schemas.error_responses import StandardError, ErrorCode, ErrorSeverity, ErrorAction
        ...
        required_fields = [
            "error_code", "message", "details", "severity", 
            "recommended_action", "retry_after", "metadata"
        ]
    ...
    def test_rate_limit_error_structure(self):
        ...
        from app.schemas.error_responses import RateLimitError, ErrorCode
