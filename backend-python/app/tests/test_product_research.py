...
class TestPerplexityResearchClient:
    ...
    async def test_research_products_success(self, mock_client_class, client, sample_product_items):
    ...
    @patch('httpx.AsyncClient')
    async def test_research_products_api_error(self, mock_client_class, client, sample_product_items):
...
class TestProductResearchService:
    ...
    async def test_create_research_job(self, mock_get_client, service, sample_product_items):
...
class TestAPIEndpoints:
    ...
    def test_product_research_request_validation(self):
        ...
        from app.schemas.product_research_in import ProductResearchRequest, ProductItemRequest
    ...
    def test_product_research_response_format(self):
        ...
        from app.schemas.product_research_out import ProductResearchResponse, ResearchMetadataResponse
