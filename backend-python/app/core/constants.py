...
DEFAULT_RESEARCH_BATCH_SIZE: Final[int] = int(
    os.getenv("DEFAULT_RESEARCH_BATCH_SIZE", "5")
)
...
# Default Model
DEFAULT_PERPLEXITY_MODEL: Final[str] = os.getenv(
    "PERPLEXITY_MODEL", PERPLEXITY_MODEL_SONAR_PRO
)
...
REQUIRED_PRODUCT_FIELDS: Final[list] = [
    "product_name",
    "category",
    "price_exact",
    "currency",
...
API_TAGS: Final[list] = [
    {"name": "제품 리서치", "description": "Perplexity AI를 활용한 제품 정보 리서치 API"},
    {"name": "작업 관리", "description": "리서치 작업 상태 관리 및 조회"},
    {"name": "헬스체크", "description": "시스템 상태 확인"},
]
