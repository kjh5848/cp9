...
class SEOException(BaseAPIException):
    ...
    def __init__(self, error_code: ErrorCode, message: Optional[str] = None, **kwargs):
...
class KeywordValidationException(SEOException):
    ...
    def __init__(self, invalid_keywords: list, reason: str, **kwargs):
        super().__init__(
...
class SEOTemplateNotFoundException(SEOException):
    ...
    def __init__(
        self, template_name: str, available_templates: Optional[list] = None, **kwargs
    ):
        super().__init__(
...
class GPTAPIException(ExternalServiceException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(error_code=error_code, service_name="gpt_api", **kwargs)
...
class GPTQuotaExceededException(GPTAPIException):
    ...
    def __init__(self, retry_after: Optional[int] = None, **kwargs):
        super().__init__(error_code=ErrorCode.GPT_API_QUOTA_EXCEEDED, **kwargs)
...
class GPTTokenLimitException(GPTAPIException):
    ...
    def __init__(self, token_count: int, max_tokens: int, **kwargs):
        super().__init__(
...
class GPTContentPolicyException(GPTAPIException):
    ...
    def __init__(self, policy_violation: str, **kwargs):
        super().__init__(
...
def map_gpt_error_to_exception(
    error: Exception, model: str = "gpt-4o"
) -> GPTAPIException:
    ...
    if "rate_limit" in error_str or "quota" in error_str:
        return GPTQuotaExceededException(
            model=model, details=f"GPT API 사용량 한도 초과: {error}"
        )
    ...
    # Content policy violations
        ...
        return GPTContentPolicyException(policy_violation=str(error), model=model)
