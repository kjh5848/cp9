...
**[절대 금지 규칙 (CRITICAL)]**
1. 추천하는 키워드에 "중국", "중국산", "중국의", "알리익스프레스", "대륙의" 와 같은 중국 관련 키워드는 **절대 포함하지 마세요**.
2. 무분별하게 "가성비"라는 단어로만 치장된 검색어를 피하고, 실질적인 구매 의도가 있는 롱테일을 선호하세요.
3. 과거 연도(예: 2023, 2024 등)가 포함된 키워드는 절대 금지합니다. 오직 올해 연도를 활용하세요.

[추천 기준]
1. 검색 의도가 분명한 롱테일 키워드 (예: "10만원대 20대 여성 생일 선물 추천")
2. 고단가/고수익 상품 위주
3. 겹치지 않는 다양한 키워드 구성
