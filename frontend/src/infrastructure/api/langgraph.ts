...
//   constructor(graphConfig: Partial<LangGraphConfig> = {}) {
//     this.config = { ...defaultLangGraphConfig, ...graphConfig };
//     this.baseUrl = config.NEXT_PUBLIC_LANGGRAPH_API_URL || '/api/langgraph';
//   }
...
//  */
// export function createLangGraphClient(graphConfig?: Partial<LangGraphConfig>): LangGraphClient {
//   return new LangGraphClient(graphConfig);
// }