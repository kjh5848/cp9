 ...
 */
export async function fetchCoupangPLBrand(params: CoupangPLBrandParams) {
 ...
 */
export async function fetchCoupangPL(params: CoupangExtendedParams = {}) {
 ...
 */
export async function fetchCoupangGoldbox(params: Omit<CoupangExtendedParams, 'limit'> = {}) {
